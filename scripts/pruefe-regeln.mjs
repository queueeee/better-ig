...
await verboten("Lesemarke in die Zukunft setzen", () =>
  supabase
...
await verboten("ein fremdes Profil umbenennen", () =>
  supabase.from("profiles").update({ display_name: "gekapert" }).neq("id", ich),
);
